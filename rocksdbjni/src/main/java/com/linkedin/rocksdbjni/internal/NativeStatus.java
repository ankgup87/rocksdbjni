...
class NativeStatus extends NativeObject
{
  ...
  static class StatusJNI
  {
    ...
    public static final native boolean ok(long self);

    @JniMethod(flags = { CPP_METHOD })
    public static final native boolean IsCorruption(long self);

    @JniMethod(flags = { CPP_METHOD })
    public static final native boolean IsNotSupported(long self);

    @JniMethod(flags = { CPP_METHOD })
    public static final native boolean IsInvalidArgument(long self);

    @JniMethod(flags = { CPP_METHOD })
    public static final native boolean IsIOError(long self);

    @JniMethod(flags = { CPP_METHOD })
    public static final native boolean IsMergeInProgress(long self);

    @JniMethod(flags = { CPP_METHOD })
    public static final native boolean IsIncomplete(long self);

    @JniMethod(flags = { CPP_METHOD })
    public static final native boolean IsNotFound(long self);

    @JniMethod(copy = "std::string", flags = { CPP_METHOD })
    public static final native long ToString(long self);
  }
