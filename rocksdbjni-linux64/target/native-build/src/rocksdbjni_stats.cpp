...
int CompactionFilterJNI_nativeFunctionCount = 5;
int CompactionFilterJNI_nativeFunctionCallCount[5];
char * CompactionFilterJNI_nativeFunctionNames[] = {
	"create",
	"delete",
	"init",
	"memmove__JLorg_fusesource_rocksdbjni_internal_NativeCompactionFilter_00024CompactionFilterJNI_2J",
	"memmove__Lorg_fusesource_rocksdbjni_internal_NativeCompactionFilter_00024CompactionFilterJNI_2JJ",
};

#define STATS_NATIVE(func) Java_org_fusesource_hawtjni_runtime_NativeStats_##func

JNIEXPORT jint JNICALL STATS_NATIVE(CompactionFilterJNI_1GetFunctionCount)
	(JNIEnv *env, jclass that)
{
	return CompactionFilterJNI_nativeFunctionCount;
}

JNIEXPORT jstring JNICALL STATS_NATIVE(CompactionFilterJNI_1GetFunctionName)
	(JNIEnv *env, jclass that, jint index)
{
	return env->NewStringUTF(CompactionFilterJNI_nativeFunctionNames[index]);
}

JNIEXPORT jint JNICALL STATS_NATIVE(CompactionFilterJNI_1GetFunctionCallCount)
	(JNIEnv *env, jclass that, jint index)
{
	return CompactionFilterJNI_nativeFunctionCallCount[index];
}
...
char * ComparatorJNI_nativeFunctionNames[] = {
	...
	"delete",
	"init",
	"memmove__JLorg_fusesource_rocksdbjni_internal_NativeComparator_00024ComparatorJNI_2J",
	"memmove__Lorg_fusesource_rocksdbjni_internal_NativeComparator_00024ComparatorJNI_2JJ",
};
...
int DBJNI_nativeFunctionCount = 18;
int DBJNI_nativeFunctionCallCount[18];
...
int MergeOperatorJNI_nativeFunctionCount = 4;
int MergeOperatorJNI_nativeFunctionCallCount[4];
char * MergeOperatorJNI_nativeFunctionNames[] = {
	"create",
	"delete",
	"init",
	"memmove",
...
JNIEXPORT jint JNICALL STATS_NATIVE(MergeOperatorJNI_1GetFunctionCount)
	(JNIEnv *env, jclass that)
{
	return MergeOperatorJNI_nativeFunctionCount;
}

JNIEXPORT jstring JNICALL STATS_NATIVE(MergeOperatorJNI_1GetFunctionName)
	(JNIEnv *env, jclass that, jint index)
{
	return env->NewStringUTF(MergeOperatorJNI_nativeFunctionNames[index]);
}

JNIEXPORT jint JNICALL STATS_NATIVE(MergeOperatorJNI_1GetFunctionCallCount)
	(JNIEnv *env, jclass that, jint index)
{
	return MergeOperatorJNI_nativeFunctionCallCount[index];
}
...
char * RangeJNI_nativeFunctionNames[] = {
	"init",
	"memmove__JLorg_fusesource_rocksdbjni_internal_NativeRange_00024RangeJNI_2J",
	"memmove__Lorg_fusesource_rocksdbjni_internal_NativeRange_00024RangeJNI_2JJ",
};
...
char * SliceJNI_nativeFunctionNames[] = {
	"delete",
	"init",
	"memmove__JLorg_fusesource_rocksdbjni_internal_NativeSlice_2J",
	"memmove__Lorg_fusesource_rocksdbjni_internal_NativeSlice_2JJ",
};
...
int StatusJNI_nativeFunctionCount = 10;
int StatusJNI_nativeFunctionCallCount[10];
...
int WriteBatchJNI_nativeFunctionCount = 7;
int WriteBatchJNI_nativeFunctionCallCount[7];
