...
#ifdef NATIVE_STATS
extern int CompactionFilterJNI_nativeFunctionCount;
extern int CompactionFilterJNI_nativeFunctionCallCount[];
extern char* CompactionFilterJNI_nativeFunctionNames[];
#define CompactionFilterJNI_NATIVE_ENTER(env, that, func) CompactionFilterJNI_nativeFunctionCallCount[func]++;
#define CompactionFilterJNI_NATIVE_EXIT(env, that, func) 
#else
#ifndef CompactionFilterJNI_NATIVE_ENTER
#define CompactionFilterJNI_NATIVE_ENTER(env, that, func) 
#endif
#ifndef CompactionFilterJNI_NATIVE_EXIT
#define CompactionFilterJNI_NATIVE_EXIT(env, that, func) 
#endif
#endif

typedef enum {
	CompactionFilterJNI_create_FUNC,
	CompactionFilterJNI_delete_FUNC,
	CompactionFilterJNI_init_FUNC,
	CompactionFilterJNI_memmove__JLorg_fusesource_rocksdbjni_internal_NativeCompactionFilter_00024CompactionFilterJNI_2J_FUNC,
	CompactionFilterJNI_memmove__Lorg_fusesource_rocksdbjni_internal_NativeCompactionFilter_00024CompactionFilterJNI_2JJ_FUNC,
} CompactionFilterJNI_FUNCS;
#ifdef NATIVE_STATS
...
typedef enum {
	...
	ComparatorJNI_memmove__JLorg_fusesource_rocksdbjni_internal_NativeComparator_00024ComparatorJNI_2J_FUNC,
	ComparatorJNI_memmove__Lorg_fusesource_rocksdbjni_internal_NativeComparator_00024ComparatorJNI_2JJ_FUNC,
} ComparatorJNI_FUNCS;
#ifdef NATIVE_STATS
...
#ifdef NATIVE_STATS
extern int MergeOperatorJNI_nativeFunctionCount;
extern int MergeOperatorJNI_nativeFunctionCallCount[];
extern char* MergeOperatorJNI_nativeFunctionNames[];
#define MergeOperatorJNI_NATIVE_ENTER(env, that, func) MergeOperatorJNI_nativeFunctionCallCount[func]++;
#define MergeOperatorJNI_NATIVE_EXIT(env, that, func) 
#else
#ifndef MergeOperatorJNI_NATIVE_ENTER
#define MergeOperatorJNI_NATIVE_ENTER(env, that, func) 
#endif
#ifndef MergeOperatorJNI_NATIVE_EXIT
#define MergeOperatorJNI_NATIVE_EXIT(env, that, func) 
#endif
#endif

typedef enum {
	MergeOperatorJNI_create_FUNC,
	MergeOperatorJNI_delete_FUNC,
	MergeOperatorJNI_init_FUNC,
	MergeOperatorJNI_memmove_FUNC,
} MergeOperatorJNI_FUNCS;
#ifdef NATIVE_STATS
...
typedef enum {
	RangeJNI_init_FUNC,
	RangeJNI_memmove__JLorg_fusesource_rocksdbjni_internal_NativeRange_00024RangeJNI_2J_FUNC,
	RangeJNI_memmove__Lorg_fusesource_rocksdbjni_internal_NativeRange_00024RangeJNI_2JJ_FUNC,
} RangeJNI_FUNCS;
#ifdef NATIVE_STATS
...
typedef enum {
	...
	SliceJNI_init_FUNC,
	SliceJNI_memmove__JLorg_fusesource_rocksdbjni_internal_NativeSlice_2J_FUNC,
	SliceJNI_memmove__Lorg_fusesource_rocksdbjni_internal_NativeSlice_2JJ_FUNC,
} SliceJNI_FUNCS;
#ifdef NATIVE_STATS
...
typedef enum {
	StatusJNI_IsCorruption_FUNC,
	StatusJNI_IsIOError_FUNC,
	StatusJNI_IsIncomplete_FUNC,
	StatusJNI_IsInvalidArgument_FUNC,
	StatusJNI_IsMergeInProgress_FUNC,
	StatusJNI_IsNotFound_FUNC,
	StatusJNI_IsNotSupported_FUNC,
...
typedef enum {
	...
	WriteBatchJNI_Merge_FUNC,
	WriteBatchJNI_Put_FUNC,
	WriteBatchJNI_PutLogData_FUNC,
