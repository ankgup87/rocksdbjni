...
struct rocksdb::Options *getNativeOptionsFields(JNIEnv *env, jobject lpObject, struct rocksdb::Options *lpStruct)
{
	...
	lpStruct->info_log = std::shared_ptr<rocksdb::Logger>((rocksdb::Logger*)(intptr_t)env->GetLongField(lpObject, NativeOptionsFc.info_log));
	lpStruct->env = (rocksdb::Env*)(intptr_t)env->GetLongField(lpObject, NativeOptionsFc.env);
	lpStruct->block_cache = std::shared_ptr<rocksdb::Cache>((rocksdb::Cache*)(intptr_t)env->GetLongField(lpObject, NativeOptionsFc.block_cache));
	lpStruct->compression = (rocksdb::CompressionType)env->GetIntField(lpObject, NativeOptionsFc.compression);
	lpStruct->merge_operator = std::shared_ptr<rocksdb::MergeOperator>((rocksdb::MergeOperator*)(intptr_t)env->GetLongField(lpObject, NativeOptionsFc.merge_operator));
...
void setNativeOptionsFields(JNIEnv *env, jobject lpObject, struct rocksdb::Options *lpStruct)
{
	...
	env->SetLongField(lpObject, NativeOptionsFc.info_log, (jlong)(intptr_t)lpStruct->info_log.get());
	env->SetLongField(lpObject, NativeOptionsFc.env, (jlong)(intptr_t)lpStruct->env);
	env->SetLongField(lpObject, NativeOptionsFc.block_cache, (jlong)(intptr_t)lpStruct->block_cache.get());
	env->SetIntField(lpObject, NativeOptionsFc.compression, (jint)lpStruct->compression);
	env->SetLongField(lpObject, NativeOptionsFc.merge_operator, (jlong)(intptr_t)lpStruct->merge_operator.get());
